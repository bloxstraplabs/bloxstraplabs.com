...
![A screenshot of the Discord settings menu in the 'Activity Privacy' submenu showing that the 'Share your detected activities with others' option needs to be enabled](../../../../assets/wiki/help-discord-activity-privacy.png)
...
![A screenshot showing a Windows User Account Control prompt of the Discord updater](../../../../assets/wiki/help-discord-activity-admin.png)
