...
<Tabs>
  ...
  ![Screenshot showing the 'Bloxstrap' project being right-clicked in the Solution Explorer, with a 'Publish' option visible](@assets-wiki/build-vs-1.webp)

  ![Screenshot showing the Visual Studio Publish menu with a 'Publish' button](@assets-wiki/build-vs-2.webp)
  </TabItem>
...
![Screenshot showing the Bloxstrap build folder, with Bloxstrap.exe present](@assets-wiki/build-artifacts.webp)
