...
![Image showing a .zip archive being extracted into the Mods folder](@assets-wiki/mods-import.webp)
...
![Image showing right-clicking on selected files in the Modifications folder and choosing 7-zip > Add to "Modifications.zip"](@assets-wiki/mods-7zip.webp)
