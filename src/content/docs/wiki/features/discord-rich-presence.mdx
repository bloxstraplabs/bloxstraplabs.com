...
You may also notice that the second image of LOCOfficial shows extra info about the game, while Natural Disaster Survival doesn't. Game developers are able to control what's shown on the activity by using [BloxstrapRPC](#) and can customise it to their game.